...
public class StackTraceFormatterTest {
    ...
    public void testFormatStackTrace() {
        ...
        String expected = "com-etsy-statsd-profiler-util-StackTraceFormatter-formatStackTraceElement_com-etsy-statsd-profiler-util-StackTraceFormatterTest-testFormatStackTraceElement";
